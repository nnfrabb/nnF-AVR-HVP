...
#define HVSP_SDO		_BV(PD2)		//tiny85:PB2
#define HVSP_SII		_BV(PD3)		//tiny85:PB1
#define HVSP_SDI		_BV(PD4)		//tiny85:PB0
#define HVSP_SCI4		_BV(PC3)		//tiny85:
